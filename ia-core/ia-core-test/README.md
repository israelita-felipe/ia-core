...
Módulo de testes que fornece base e utilitários para testar múltiplos módulos de forma integrada. Define setup, fixtures, e helpers para testes end-to-end.
...
public class UserControllerIntegrationTest extends IntegrationTestBase {
    ...
    public void testGetUser() throws Exception {
        ...
        // Act & Assert
        mockMvc.perform(
            get("/api/${api.version}/users/{id}", user.getId())
                .header("Authorization", "Bearer " + token)
        )
            .andExpect(status().isOk())
    ...
    public void testUnauthorizedAccess() throws Exception {
        mockMvc.perform(get("/api/${api.version}/users"))
