...
/**
 * Interface listener para parse tree gerada pelo {@link LeituraParser}.
 * <p>
 * Interface gerada automaticamente pelo ANTLR 4.13.2 a partir do arquivo Leitura.g4.
 * Define métodos para entrar e sair de cada regra da gramática durante o parsing.
 *
