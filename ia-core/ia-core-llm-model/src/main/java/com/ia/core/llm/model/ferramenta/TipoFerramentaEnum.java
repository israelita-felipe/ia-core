 ...
 * recurso MCP ou skill (capacidade composta com instruções e sub-ferramentas).
 *
...
public enum TipoFerramentaEnum {
  ...
  /**
   * Skill - capacidade composta com instruções, template e sub-ferramentas autorizadas.
   */
  SKILL("Skill", "Capacidade composta com instruções, template e sub-ferramentas autorizadas");
