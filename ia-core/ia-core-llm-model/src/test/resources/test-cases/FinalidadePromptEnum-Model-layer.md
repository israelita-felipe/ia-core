# Casos de Teste - FinalidadePromptEnum (Model Layer)

## Contexto
A classe `FinalidadePromptEnum` é um enum que define as finalidades dos prompts no sistema LLM.
...
**Passos**:
1. Chamar FinalidadePromptEnum.values()
