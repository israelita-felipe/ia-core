# Casos de Teste - TemplateParameterEnum (Model Layer)

## Contexto
A classe `TemplateParameterEnum` é um enum que define os tipos de parâmetros de template no sistema LLM.
...
**Passos**:
1. Chamar TemplateParameterEnum.values()
