# FlywayExecutionDTO - Casos de Teste da Camada de API

## Visão Geral
Casos de teste para a classe `FlywayExecutionDTO`, verificando campos de transferência de dados de execução Flyway.
...
- **Dado**: Uma FlywayExecutionDTO com campos preenchidos
...
## Fluxo do Teste
1. Criar instância de FlywayExecutionDTO
