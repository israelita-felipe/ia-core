# Caso de Teste: LogOperation - Model

## Descrição
Caso de teste para o modelo de segurança `LogOperation`.

## Classe Testada
`com.ia.core.security.model.log.operation.LogOperation`

## Stack do DTO
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.security.model.log.operation.LogOperation](../../../../ia-core-security-model/src/main/java/com/ia/core/security/model/log/operation/LogOperation.java) | Implementado |
| Repository | LogOperationRepository | Implementado |
| Mapper | LogOperationMapper | Implementado |
| ServiceModel | [com.ia.core.security.model.log.operation.LogOperation](../../../../ia-core-security-model/src/main/java/com/ia/core/security/model/log/operation/LogOperation.java) | Implementado |
...
## Objetivo
Documentar e validar a camada model de `LogOperation` dentro da stack de segurança do `ia-core-security-*`.

## Fluxo do Teste
1. Dado o contexto de segurança `Auditoria de Operação` no domínio `Manter Security`.
2. Quando a camada model recebe, produz ou transforma dados compatíveis com `LogOperation`.
3. Então o comportamento deve preservar os campos `userName, userCode, valueId, type, oldValue, newValue, dateTimeOperation, operation`.
...
**Given**: Dados válidos para `LogOperation` no contexto `Auditoria de Operação`.
...
**When**: A camada model valida ou transforma `LogOperation`.
...
**Given**: Caso de teste documentado para `LogOperation`.
...
- Classe: [`LogOperation`](../../../../ia-core-security-model/src/main/java/com/ia/core/security/model/log/operation/LogOperation.java)
