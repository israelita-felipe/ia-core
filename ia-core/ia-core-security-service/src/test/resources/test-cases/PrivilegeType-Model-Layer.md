# Caso de Teste: PrivilegeType - Model

## Descrição
Caso de teste para o modelo de segurança `PrivilegeType`.

## Classe Testada
`com.ia.core.security.model.privilege.PrivilegeType`

## Stack do DTO
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.security.model.privilege.PrivilegeType](../../../../ia-core-security-model/src/main/java/com/ia/core/security/model/privilege/PrivilegeType.java) | Implementado |
...
| ServiceModel | [com.ia.core.security.model.privilege.PrivilegeType](../../../../ia-core-security-model/src/main/java/com/ia/core/security/model/privilege/PrivilegeType.java) | Implementado |
...
## Objetivo
Documentar e validar a camada model de `PrivilegeType` dentro da stack de segurança do `ia-core-security-*`.

## Fluxo do Teste
1. Dado o contexto de segurança `Privilégio` no domínio `Manter Security`.
2. Quando a camada model recebe, produz ou transforma dados compatíveis com `PrivilegeType`.
3. Então o comportamento deve preservar os campos `codigo`.
...
**Given**: Dados válidos para `PrivilegeType` no contexto `Privilégio`.
...
**When**: A camada model valida ou transforma `PrivilegeType`.
...
**Given**: Caso de teste documentado para `PrivilegeType`.
...
| Campo | Valor |
|-------|-------|
| Componente | `PrivilegeType - Model` |
| Camada | Model |
...
- Classe: [`PrivilegeType`](../../../../ia-core-security-model/src/main/java/com/ia/core/security/model/privilege/PrivilegeType.java)
