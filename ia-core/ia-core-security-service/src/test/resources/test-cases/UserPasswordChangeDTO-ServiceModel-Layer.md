# Caso de Teste: UserPasswordChangeDTO - ServiceModel

## Descrição
Caso de teste para a camada servicemodel do DTO `UserPasswordChangeDTO`.

## Classe Testada
`com.ia.core.security.service.model.user.UserPasswordChangeDTO`

## Stack do DTO
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.security.service.model.user.UserPasswordChangeDTO](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/user/UserPasswordChangeDTO.java) | Implementado |
| Repository | UserRepository | Implementado |
| Mapper | UserMapper / UserRoleMapper / UserPrivilegeMapper | Implementado |
| ServiceModel | [com.ia.core.security.service.model.user.UserPasswordChangeDTO](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/user/UserPasswordChangeDTO.java) | Implementado |
| Service | UserService | Implementado |
| API/REST | Não implementado no módulo ia-core-security-rest | Não implementado |
| View/Client | UserManager / UserClient | Implementado |


## Objetivo
Documentar e validar a camada servicemodel de `UserPasswordChangeDTO` dentro da stack de segurança do `ia-core-security-*`.

## Fluxo do Teste
1. Dado o contexto de segurança `Usuário` no domínio `Manter Security`.
2. Quando a camada servicemodel recebe, produz ou transforma dados compatíveis com `UserPasswordChangeDTO`.
3. Então o comportamento deve preservar os campos `userCode, oldPassword, newPassword`.
...
**Given**: Dados válidos para `UserPasswordChangeDTO` no contexto `Usuário`.
...
**When**: A camada servicemodel valida ou transforma `UserPasswordChangeDTO`.
...
**Given**: Caso de teste documentado para `UserPasswordChangeDTO`.
...
| Campo | Valor |
|-------|-------|
| Componente | `UserPasswordChangeDTO - ServiceModel` |
| Camada | ServiceModel |
...
- Classe: [`UserPasswordChangeDTO`](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/user/UserPasswordChangeDTO.java)
