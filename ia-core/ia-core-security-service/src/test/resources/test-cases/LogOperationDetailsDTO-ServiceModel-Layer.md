# Caso de Teste: LogOperationDetails - ServiceModel

## Descrição
Caso de teste para a camada servicemodel do DTO `LogOperationDetails`.

## Classe Testada
`com.ia.core.security.service.model.log.operation.LogOperationDetails`

## Stack do DTO
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.security.service.model.log.operation.LogOperationDetails](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/log/operation/LogOperationDetails.java) | Implementado |
| Repository | LogOperationRepository | Implementado |
| Mapper | LogOperationMapper | Implementado |
| ServiceModel | [com.ia.core.security.service.model.log.operation.LogOperationDetails](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/log/operation/LogOperationDetails.java) | Implementado |
...
## Objetivo
Documentar e validar a camada servicemodel de `LogOperationDetails` dentro da stack de segurança do `ia-core-security-*`.

## Fluxo do Teste
1. Dado o contexto de segurança `Auditoria de Operação` no domínio `Manter Security`.
2. Quando a camada servicemodel recebe, produz ou transforma dados compatíveis com `LogOperationDetails`.
3. Então o comportamento deve preservar os campos `logOperation, Object, itens`.
...
**Given**: Dados válidos para `LogOperationDetails` no contexto `Auditoria de Operação`.
...
**When**: A camada servicemodel valida ou transforma `LogOperationDetails`.
...
**Given**: Caso de teste documentado para `LogOperationDetails`.
...
| Campo | Valor |
|-------|-------|
| Componente | `LogOperationDetails - ServiceModel` |
| Camada | ServiceModel |
...
- Classe: [`LogOperationDetails`](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/log/operation/LogOperationDetails.java)
