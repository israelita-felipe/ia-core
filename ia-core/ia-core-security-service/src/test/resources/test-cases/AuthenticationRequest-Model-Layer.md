# Caso de Teste: AuthenticationRequest - Model

## Descrição
Caso de teste para o modelo de segurança `AuthenticationRequest`.

## Classe Testada
`com.ia.core.security.model.authentication.AuthenticationRequest`

## Stack do DTO
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.security.model.authentication.AuthenticationRequest](../../../../ia-core-security-model/src/main/java/com/ia/core/security/model/authentication/AuthenticationRequest.java) | Implementado |
| Repository | UserRepository quando aplicável | Implementado |
| Mapper | LoginTranslator | Implementado |
| ServiceModel | [com.ia.core.security.model.authentication.AuthenticationRequest](../../../../ia-core-security-model/src/main/java/com/ia/core/security/model/authentication/AuthenticationRequest.java) | Implementado |
...
## Objetivo
Documentar e validar a camada model de `AuthenticationRequest` dentro da stack de segurança do `ia-core-security-*`.

## Fluxo do Teste
1. Dado o contexto de segurança `Autenticação e JWT` no domínio `Manter Security`.
2. Quando a camada model recebe, produz ou transforma dados compatíveis com `AuthenticationRequest`.
3. Então o comportamento deve preservar os campos `codUsuario, senha, refreshToken`.
...
**Given**: Dados válidos para `AuthenticationRequest` no contexto `Autenticação e JWT`.
...
**When**: A camada model valida ou transforma `AuthenticationRequest`.
...
**Given**: Caso de teste documentado para `AuthenticationRequest`.
...
| Campo | Valor |
|-------|-------|
| Componente | `AuthenticationRequest - Model` |
| Camada | Model |
...
- Classe: [`AuthenticationRequest`](../../../../ia-core-security-model/src/main/java/com/ia/core/security/model/authentication/AuthenticationRequest.java)
