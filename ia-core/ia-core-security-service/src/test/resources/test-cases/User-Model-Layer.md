# Caso de Teste: User - Model

## Descrição
Caso de teste para o modelo de segurança `User`.

## Classe Testada
`com.ia.core.security.model.user.User`

## Stack do DTO
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.security.model.user.User](../../../../ia-core-security-model/src/main/java/com/ia/core/security/model/user/User.java) | Implementado |
| Repository | UserRepository | Implementado |
| Mapper | UserMapper / UserRoleMapper / UserPrivilegeMapper | Implementado |
| ServiceModel | [com.ia.core.security.model.user.User](../../../../ia-core-security-model/src/main/java/com/ia/core/security/model/user/User.java) | Implementado |
...
## Objetivo
Documentar e validar a camada model de `User` dentro da stack de segurança do `ia-core-security-*`.

## Fluxo do Teste
1. Dado o contexto de segurança `Usuário` no domínio `Manter Security`.
2. Quando a camada model recebe, produz ou transforma dados compatíveis com `User`.
3. Então o comportamento deve preservar os campos `userName, userCode, password, enabled, roles, privileges`.
...
**Given**: Dados válidos para `User` no contexto `Usuário`.
...
**When**: A camada model valida ou transforma `User`.
...
**Given**: Caso de teste documentado para `User`.
...
- Classe: [`User`](../../../../ia-core-security-model/src/main/java/com/ia/core/security/model/user/User.java)
