# Caso de Teste: UserSearchRequest - ServiceModel

## Descrição
Caso de teste para a camada servicemodel do DTO `UserSearchRequest`.

## Classe Testada
`com.ia.core.security.service.model.user.UserSearchRequest`

## Stack do DTO
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.security.service.model.user.UserSearchRequest](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/user/UserSearchRequest.java) | Implementado |
| Repository | UserRepository | Implementado |
| Mapper | UserMapper / UserRoleMapper / UserPrivilegeMapper | Implementado |
| ServiceModel | [com.ia.core.security.service.model.user.UserSearchRequest](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/user/UserSearchRequest.java) | Implementado |
...
## Objetivo
Documentar e validar a camada servicemodel de `UserSearchRequest` dentro da stack de segurança do `ia-core-security-*`.

## Fluxo do Teste
1. Dado o contexto de segurança `Usuário` no domínio `Manter Security`.
2. Quando a camada servicemodel recebe, produz ou transforma dados compatíveis com `UserSearchRequest`.
...
**Given**: Dados válidos para `UserSearchRequest` no contexto `Usuário`.
...
**When**: A camada servicemodel valida ou transforma `UserSearchRequest`.
...
**Given**: Caso de teste documentado para `UserSearchRequest`.
...
| Campo | Valor |
|-------|-------|
| Componente | `UserSearchRequest - ServiceModel` |
| Camada | ServiceModel |
...
- Classe: [`UserSearchRequest`](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/user/UserSearchRequest.java)
