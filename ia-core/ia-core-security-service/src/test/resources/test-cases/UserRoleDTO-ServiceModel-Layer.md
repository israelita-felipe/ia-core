# Caso de Teste: UserRoleDTO - ServiceModel

## Descrição
Caso de teste para a camada servicemodel do DTO `UserRoleDTO`.

## Classe Testada
`com.ia.core.security.service.model.user.UserRoleDTO`

## Stack do DTO
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.security.service.model.user.UserRoleDTO](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/user/UserRoleDTO.java) | Implementado |
| Repository | UserRepository | Implementado |
| Mapper | UserMapper / UserRoleMapper / UserPrivilegeMapper | Implementado |
| ServiceModel | [com.ia.core.security.service.model.user.UserRoleDTO](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/user/UserRoleDTO.java) | Implementado |
...
## Objetivo
Documentar e validar a camada servicemodel de `UserRoleDTO` dentro da stack de segurança do `ia-core-security-*`.

## Fluxo do Teste
1. Dado o contexto de segurança `Usuário` no domínio `Manter Security`.
2. Quando a camada servicemodel recebe, produz ou transforma dados compatíveis com `UserRoleDTO`.
3. Então o comportamento deve preservar os campos `name, privileges`.
...
**Given**: Dados válidos para `UserRoleDTO` no contexto `Usuário`.
...
**When**: A camada servicemodel valida ou transforma `UserRoleDTO`.
...
**Given**: Caso de teste documentado para `UserRoleDTO`.
...
| Campo | Valor |
|-------|-------|
| Componente | `UserRoleDTO - ServiceModel` |
| Camada | ServiceModel |
...
- Classe: [`UserRoleDTO`](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/user/UserRoleDTO.java)
