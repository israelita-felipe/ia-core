# Caso de Teste: LogOperationSearchRequest - ServiceModel

## Descrição
Caso de teste para a camada servicemodel do DTO `LogOperationSearchRequest`.

## Classe Testada
`com.ia.core.security.service.model.log.operation.LogOperationSearchRequest`

## Stack do DTO
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.security.service.model.log.operation.LogOperationSearchRequest](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/log/operation/LogOperationSearchRequest.java) | Implementado |
| Repository | LogOperationRepository | Implementado |
| Mapper | LogOperationMapper | Implementado |
| ServiceModel | [com.ia.core.security.service.model.log.operation.LogOperationSearchRequest](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/log/operation/LogOperationSearchRequest.java) | Implementado |
...
## Objetivo
Documentar e validar a camada servicemodel de `LogOperationSearchRequest` dentro da stack de segurança do `ia-core-security-*`.

## Fluxo do Teste
1. Dado o contexto de segurança `Auditoria de Operação` no domínio `Manter Security`.
2. Quando a camada servicemodel recebe, produz ou transforma dados compatíveis com `LogOperationSearchRequest`.
...
**Given**: Dados válidos para `LogOperationSearchRequest` no contexto `Auditoria de Operação`.
...
**When**: A camada servicemodel valida ou transforma `LogOperationSearchRequest`.
...
**Given**: Caso de teste documentado para `LogOperationSearchRequest`.
...
| Campo | Valor |
|-------|-------|
| Componente | `LogOperationSearchRequest - ServiceModel` |
| Camada | ServiceModel |
...
- Classe: [`LogOperationSearchRequest`](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/log/operation/LogOperationSearchRequest.java)
