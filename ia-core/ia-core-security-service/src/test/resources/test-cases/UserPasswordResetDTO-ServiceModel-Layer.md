# Caso de Teste: UserPasswordResetDTO - ServiceModel

## Descrição
Caso de teste para a camada servicemodel do DTO `UserPasswordResetDTO`.

## Classe Testada
`com.ia.core.security.service.model.user.UserPasswordResetDTO`

## Stack do DTO
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.security.service.model.user.UserPasswordResetDTO](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/user/UserPasswordResetDTO.java) | Implementado |
| Repository | UserRepository | Implementado |
| Mapper | UserMapper / UserRoleMapper / UserPrivilegeMapper | Implementado |
| ServiceModel | [com.ia.core.security.service.model.user.UserPasswordResetDTO](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/user/UserPasswordResetDTO.java) | Implementado |
...
## Objetivo
Documentar e validar a camada servicemodel de `UserPasswordResetDTO` dentro da stack de segurança do `ia-core-security-*`.

## Fluxo do Teste
1. Dado o contexto de segurança `Usuário` no domínio `Manter Security`.
2. Quando a camada servicemodel recebe, produz ou transforma dados compatíveis com `UserPasswordResetDTO`.
3. Então o comportamento deve preservar os campos `userCode, userCodeRequester`.
...
**Given**: Dados válidos para `UserPasswordResetDTO` no contexto `Usuário`.
...
**When**: A camada servicemodel valida ou transforma `UserPasswordResetDTO`.
...
**Given**: Caso de teste documentado para `UserPasswordResetDTO`.
...
| Campo | Valor |
|-------|-------|
| Componente | `UserPasswordResetDTO - ServiceModel` |
| Camada | ServiceModel |
...
- Classe: [`UserPasswordResetDTO`](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/user/UserPasswordResetDTO.java)
