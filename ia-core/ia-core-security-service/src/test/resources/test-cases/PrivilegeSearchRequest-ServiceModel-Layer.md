# Caso de Teste: PrivilegeSearchRequest - ServiceModel

## Descrição
Caso de teste para a camada servicemodel do DTO `PrivilegeSearchRequest`.

## Classe Testada
`com.ia.core.security.service.model.privilege.PrivilegeSearchRequest`

## Stack do DTO
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.security.service.model.privilege.PrivilegeSearchRequest](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/privilege/PrivilegeSearchRequest.java) | Implementado |
...
| ServiceModel | [com.ia.core.security.service.model.privilege.PrivilegeSearchRequest](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/privilege/PrivilegeSearchRequest.java) | Implementado |
...
## Objetivo
Documentar e validar a camada servicemodel de `PrivilegeSearchRequest` dentro da stack de segurança do `ia-core-security-*`.

## Fluxo do Teste
1. Dado o contexto de segurança `Privilégio` no domínio `Manter Security`.
2. Quando a camada servicemodel recebe, produz ou transforma dados compatíveis com `PrivilegeSearchRequest`.
...
**Given**: Dados válidos para `PrivilegeSearchRequest` no contexto `Privilégio`.
...
**When**: A camada servicemodel valida ou transforma `PrivilegeSearchRequest`.
...
**Given**: Caso de teste documentado para `PrivilegeSearchRequest`.
...
| Campo | Valor |
|-------|-------|
| Componente | `PrivilegeSearchRequest - ServiceModel` |
| Camada | ServiceModel |
...
- Classe: [`PrivilegeSearchRequest`](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/privilege/PrivilegeSearchRequest.java)
