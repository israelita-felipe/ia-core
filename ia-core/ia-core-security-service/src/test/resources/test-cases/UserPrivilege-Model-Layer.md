# Caso de Teste: UserPrivilege - Model

## Descrição
Caso de teste para o modelo de segurança `UserPrivilege`.

## Classe Testada
`com.ia.core.security.model.user.UserPrivilege`

## Stack do DTO
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.security.model.user.UserPrivilege](../../../../ia-core-security-model/src/main/java/com/ia/core/security/model/user/UserPrivilege.java) | Implementado |
| Repository | UserRepository | Implementado |
| Mapper | UserMapper / UserRoleMapper / UserPrivilegeMapper | Implementado |
| ServiceModel | [com.ia.core.security.model.user.UserPrivilege](../../../../ia-core-security-model/src/main/java/com/ia/core/security/model/user/UserPrivilege.java) | Implementado |
...
## Objetivo
Documentar e validar a camada model de `UserPrivilege` dentro da stack de segurança do `ia-core-security-*`.

## Fluxo do Teste
1. Dado o contexto de segurança `Usuário` no domínio `Manter Security`.
2. Quando a camada model recebe, produz ou transforma dados compatíveis com `UserPrivilege`.
3. Então o comportamento deve preservar os campos `privilege, user, operations`.
...
**Given**: Dados válidos para `UserPrivilege` no contexto `Usuário`.
...
**When**: A camada model valida ou transforma `UserPrivilege`.
...
**Given**: Caso de teste documentado para `UserPrivilege`.
...
| Campo | Valor |
|-------|-------|
| Componente | `UserPrivilege - Model` |
| Camada | Model |
...
- Classe: [`UserPrivilege`](../../../../ia-core-security-model/src/main/java/com/ia/core/security/model/user/UserPrivilege.java)
