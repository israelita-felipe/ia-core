# Caso de Teste: RoleDTO - ServiceModel

## Descrição
Caso de teste para a camada servicemodel do DTO `RoleDTO`.

## Classe Testada
`com.ia.core.security.service.model.role.RoleDTO`

## Stack do DTO
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.security.service.model.role.RoleDTO](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/role/RoleDTO.java) | Implementado |
| Repository | RoleRepository | Implementado |
| Mapper | RoleMapper / RolePrivilegeMapper | Implementado |
| ServiceModel | [com.ia.core.security.service.model.role.RoleDTO](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/role/RoleDTO.java) | Implementado |
...
## Objetivo
Documentar e validar a camada servicemodel de `RoleDTO` dentro da stack de segurança do `ia-core-security-*`.

## Fluxo do Teste
1. Dado o contexto de segurança `Papel` no domínio `Manter Security`.
2. Quando a camada servicemodel recebe, produz ou transforma dados compatíveis com `RoleDTO`.
3. Então o comportamento deve preservar os campos `name, users, privileges`.
...
**Given**: Dados válidos para `RoleDTO` no contexto `Papel`.
...
**When**: A camada servicemodel valida ou transforma `RoleDTO`.
...
**Given**: Caso de teste documentado para `RoleDTO`.
...
| Campo | Valor |
|-------|-------|
| Componente | `RoleDTO - ServiceModel` |
| Camada | ServiceModel |
...
- Classe: [`RoleDTO`](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/role/RoleDTO.java)
