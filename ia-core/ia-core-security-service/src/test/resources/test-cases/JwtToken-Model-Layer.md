# Caso de Teste: JwtToken - Model

## Descrição
Caso de teste para o modelo de segurança `JwtToken`.

## Classe Testada
`com.ia.core.security.model.authentication.JwtToken`

## Stack do DTO
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.security.model.authentication.JwtToken](../../../../ia-core-security-model/src/main/java/com/ia/core/security/model/authentication/JwtToken.java) | Implementado |
| Repository | UserRepository quando aplicável | Implementado |
| Mapper | LoginTranslator | Implementado |
| ServiceModel | [com.ia.core.security.model.authentication.JwtToken](../../../../ia-core-security-model/src/main/java/com/ia/core/security/model/authentication/JwtToken.java) | Implementado |
...
## Objetivo
Documentar e validar a camada model de `JwtToken` dentro da stack de segurança do `ia-core-security-*`.

## Fluxo do Teste
1. Dado o contexto de segurança `Autenticação e JWT` no domínio `Manter Security`.
2. Quando a camada model recebe, produz ou transforma dados compatíveis com `JwtToken`.
3. Então o comportamento deve preservar os campos `value, issuedAt, expiration, void`.
...
**Given**: Dados válidos para `JwtToken` no contexto `Autenticação e JWT`.
...
**When**: A camada model valida ou transforma `JwtToken`.
...
**Given**: Caso de teste documentado para `JwtToken`.
...
- Classe: [`JwtToken`](../../../../ia-core-security-model/src/main/java/com/ia/core/security/model/authentication/JwtToken.java)
