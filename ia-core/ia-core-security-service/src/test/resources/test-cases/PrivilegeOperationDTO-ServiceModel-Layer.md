# Caso de Teste: PrivilegeOperationDTO - ServiceModel

## Descrição
Caso de teste para a camada servicemodel do DTO `PrivilegeOperationDTO`.

## Classe Testada
`com.ia.core.security.service.model.privilege.PrivilegeOperationDTO`

## Stack do DTO
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.security.service.model.privilege.PrivilegeOperationDTO](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/privilege/PrivilegeOperationDTO.java) | Implementado |
...
| ServiceModel | [com.ia.core.security.service.model.privilege.PrivilegeOperationDTO](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/privilege/PrivilegeOperationDTO.java) | Implementado |
...
## Objetivo
Documentar e validar a camada servicemodel de `PrivilegeOperationDTO` dentro da stack de segurança do `ia-core-security-*`.

## Fluxo do Teste
1. Dado o contexto de segurança `Privilégio` no domínio `Manter Security`.
2. Quando a camada servicemodel recebe, produz ou transforma dados compatíveis com `PrivilegeOperationDTO`.
3. Então o comportamento deve preservar os campos `operation, context`.
...
**Given**: Dados válidos para `PrivilegeOperationDTO` no contexto `Privilégio`.
...
**When**: A camada servicemodel valida ou transforma `PrivilegeOperationDTO`.
...
**Given**: Caso de teste documentado para `PrivilegeOperationDTO`.
...
| Campo | Valor |
|-------|-------|
| Componente | `PrivilegeOperationDTO - ServiceModel` |
| Camada | ServiceModel |
...
- Classe: [`PrivilegeOperationDTO`](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/privilege/PrivilegeOperationDTO.java)
