# Caso de Teste: UserPrivilegeDTO - ServiceModel

## Descrição
Caso de teste para a camada servicemodel do DTO `UserPrivilegeDTO`.

## Classe Testada
`com.ia.core.security.service.model.user.UserPrivilegeDTO`

## Stack do DTO
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.security.service.model.user.UserPrivilegeDTO](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/user/UserPrivilegeDTO.java) | Implementado |
| Repository | UserRepository | Implementado |
| Mapper | UserMapper / UserRoleMapper / UserPrivilegeMapper | Implementado |
| ServiceModel | [com.ia.core.security.service.model.user.UserPrivilegeDTO](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/user/UserPrivilegeDTO.java) | Implementado |
...
## Objetivo
Documentar e validar a camada servicemodel de `UserPrivilegeDTO` dentro da stack de segurança do `ia-core-security-*`.

## Fluxo do Teste
1. Dado o contexto de segurança `Usuário` no domínio `Manter Security`.
2. Quando a camada servicemodel recebe, produz ou transforma dados compatíveis com `UserPrivilegeDTO`.
3. Então o comportamento deve preservar os campos `privilege, operations`.
...
**Given**: Dados válidos para `UserPrivilegeDTO` no contexto `Usuário`.
...
**When**: A camada servicemodel valida ou transforma `UserPrivilegeDTO`.
...
**Given**: Caso de teste documentado para `UserPrivilegeDTO`.
...
| Campo | Valor |
|-------|-------|
| Componente | `UserPrivilegeDTO - ServiceModel` |
| Camada | ServiceModel |
...
- Classe: [`UserPrivilegeDTO`](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/user/UserPrivilegeDTO.java)
