# Caso de Teste: OperationItemDetails - ServiceModel

## Descrição
Caso de teste para a camada servicemodel do DTO `OperationItemDetails`.

## Classe Testada
`com.ia.core.security.service.model.log.operation.OperationItemDetails`

## Stack do DTO
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.security.service.model.log.operation.OperationItemDetails](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/log/operation/OperationItemDetails.java) | Implementado |
| Repository | LogOperationRepository | Implementado |
| Mapper | LogOperationMapper | Implementado |
| ServiceModel | [com.ia.core.security.service.model.log.operation.OperationItemDetails](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/log/operation/OperationItemDetails.java) | Implementado |
...
## Objetivo
Documentar e validar a camada servicemodel de `OperationItemDetails` dentro da stack de segurança do `ia-core-security-*`.

## Fluxo do Teste
1. Dado o contexto de segurança `Auditoria de Operação` no domínio `Manter Security`.
2. Quando a camada servicemodel recebe, produz ou transforma dados compatíveis com `OperationItemDetails`.
3. Então o comportamento deve preservar os campos `property, oldValue, newValue`.
...
**Given**: Dados válidos para `OperationItemDetails` no contexto `Auditoria de Operação`.
...
**When**: A camada servicemodel valida ou transforma `OperationItemDetails`.
...
**Given**: Caso de teste documentado para `OperationItemDetails`.
...
| Campo | Valor |
|-------|-------|
| Componente | `OperationItemDetails - ServiceModel` |
| Camada | ServiceModel |
...
- Classe: [`OperationItemDetails`](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/log/operation/OperationItemDetails.java)
