# Caso de Teste: PrivilegeDTO - ServiceModel

## Descrição
Caso de teste para a camada servicemodel do DTO `PrivilegeDTO`.

## Classe Testada
`com.ia.core.security.service.model.privilege.PrivilegeDTO`

## Stack do DTO
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.security.service.model.privilege.PrivilegeDTO](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/privilege/PrivilegeDTO.java) | Implementado |
...
| ServiceModel | [com.ia.core.security.service.model.privilege.PrivilegeDTO](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/privilege/PrivilegeDTO.java) | Implementado |
...
## Objetivo
Documentar e validar a camada servicemodel de `PrivilegeDTO` dentro da stack de segurança do `ia-core-security-*`.

## Fluxo do Teste
1. Dado o contexto de segurança `Privilégio` no domínio `Manter Security`.
2. Quando a camada servicemodel recebe, produz ou transforma dados compatíveis com `PrivilegeDTO`.
3. Então o comportamento deve preservar os campos `name, type, values`.
...
**Given**: Dados válidos para `PrivilegeDTO` no contexto `Privilégio`.
...
**When**: A camada servicemodel valida ou transforma `PrivilegeDTO`.
...
**Given**: Caso de teste documentado para `PrivilegeDTO`.
...
| Campo | Valor |
|-------|-------|
| Componente | `PrivilegeDTO - ServiceModel` |
| Camada | ServiceModel |
...
- Classe: [`PrivilegeDTO`](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/privilege/PrivilegeDTO.java)
