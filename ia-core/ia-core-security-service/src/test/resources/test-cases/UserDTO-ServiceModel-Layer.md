# Caso de Teste: UserDTO - ServiceModel

## Descrição
Caso de teste para a camada servicemodel do DTO `UserDTO`.

## Classe Testada
`com.ia.core.security.service.model.user.UserDTO`

## Stack do DTO
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.security.service.model.user.UserDTO](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/user/UserDTO.java) | Implementado |
| Repository | UserRepository | Implementado |
| Mapper | UserMapper / UserRoleMapper / UserPrivilegeMapper | Implementado |
| ServiceModel | [com.ia.core.security.service.model.user.UserDTO](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/user/UserDTO.java) | Implementado |
...
## Objetivo
Documentar e validar a camada servicemodel de `UserDTO` dentro da stack de segurança do `ia-core-security-*`.

## Fluxo do Teste
1. Dado o contexto de segurança `Usuário` no domínio `Manter Security`.
2. Quando a camada servicemodel recebe, produz ou transforma dados compatíveis com `UserDTO`.
3. Então o comportamento deve preservar os campos `userName, userCode, password, enabled, accountNotExpired, accountNotLocked, credentialsNotExpired, privileges, roles`.
...
**Given**: Dados válidos para `UserDTO` no contexto `Usuário`.
...
**When**: A camada servicemodel valida ou transforma `UserDTO`.
...
**Given**: Caso de teste documentado para `UserDTO`.
...
| Campo | Valor |
|-------|-------|
| Componente | `UserDTO - ServiceModel` |
| Camada | ServiceModel |
...
- Classe: [`UserDTO`](../../../../ia-core-security-service-model/src/main/java/com/ia/core/security/service/model/user/UserDTO.java)
