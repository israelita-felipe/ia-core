# Caso de Teste: OperationEnum - Model

## Descrição
Caso de teste para o modelo de segurança `OperationEnum`.

## Classe Testada
`com.ia.core.security.model.functionality.OperationEnum`

## Stack do DTO
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.security.model.functionality.OperationEnum](../../../../ia-core-security-model/src/main/java/com/ia/core/security/model/functionality/OperationEnum.java) | Implementado |
| Repository | Não implementado | Não implementado |
| Mapper | Não implementado | Não implementado |
| ServiceModel | [com.ia.core.security.model.functionality.OperationEnum](../../../../ia-core-security-model/src/main/java/com/ia/core/security/model/functionality/OperationEnum.java) | Implementado |
| Service | Não implementado | Não implementado |
| API/REST | Não implementado no módulo ia-core-security-rest | Não implementado |
| View/Client | Não implementado | Não implementado |


## Objetivo
Documentar e validar a camada model de `OperationEnum` dentro da stack de segurança do `ia-core-security-*`.

## Fluxo do Teste
1. Dado o contexto de segurança `Segurança` no domínio `Manter Security`.
2. Quando a camada model recebe, produz ou transforma dados compatíveis com `OperationEnum`.
...
**Given**: Dados válidos para `OperationEnum` no contexto `Segurança`.
...
**When**: A camada model valida ou transforma `OperationEnum`.
...
**Given**: Caso de teste documentado para `OperationEnum`.
...
| Campo | Valor |
|-------|-------|
| Componente | `OperationEnum - Model` |
| Camada | Model |
...
- Classe: [`OperationEnum`](../../../../ia-core-security-model/src/main/java/com/ia/core/security/model/functionality/OperationEnum.java)
