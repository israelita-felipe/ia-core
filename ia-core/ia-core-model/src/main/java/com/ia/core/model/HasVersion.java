 ...
 *
 * <p>Utilizada para implementar lock otimista no JPA, prevenindo conflitos de
 * concorrência em ambientes com múltiplas transações simultâneas.
 *
 * <p><b>Por quê usar HasVersion?</b></p>
 * <ul>
...
public interface HasVersion {
   ...
   *
   * <p>Normalmente gerenciado automaticamente pelo JPA, mas pode ser
   * manipulado em cenários específicos de migracao ou testes.
   *
