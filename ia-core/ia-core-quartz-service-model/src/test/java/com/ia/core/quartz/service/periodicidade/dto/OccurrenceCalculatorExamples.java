 ...
 * <p>
 * Esta classe demonstra различные cenários de uso para cálculo de ocorrências
 * de eventos periódicos conforme RFC 5545.
 *
 * @author Israel Araújo
 */
public class OccurrenceCalculatorExamples {

  private final OccurrenceCalculator calculator = OccurrenceCalculator
      .libRecurCalculator();

  /**
   * Exemplo 1: Evento diário simples
   * <p>
   * Cria um evento que ocorre todos os dias às 10:00, com duração de 1 hora.
   */
  public void exemploEventoDiario() {
    ...
    IntervaloTemporalDTO intervalo = IntervaloTemporalDTO.builder()
        .startDate(LocalDate.of(2026, 1, 15)).startTime(LocalTime.of(10, 0))
        .endDate(LocalDate.of(2026, 1, 15)).endTime(LocalTime.of(11, 0))
        .build();

    // Regra de recorrência: diário
    RecorrenciaDTO regra = RecorrenciaDTO.builder()
        .frequency(Frequencia.DIARIAMENTE).intervalValue(1).build();

    // Periodicidade completa
    PeriodicidadeDTO periodicidade = PeriodicidadeDTO.builder()
        .intervaloBase(intervalo).regra(regra)
        .zoneId(ZoneId.of("America/Recife").getId()).build();

    // Busca próximas 5 ocorrências a partir de hoje
    ZonedDateTime from = ZonedDateTime.now(ZoneId.of("America/Recife"));
    List<IntervaloTemporalDTO> occurrences = calculator
    ...
    for (IntervaloTemporalDTO occ : occurrences) {
      ...
      String endStr = (occ.getEndDate() != null ? occ.getEndDate()
                                                : occ.getStartDate())
          + " " + (occ.getEndTime() != null ? occ.getEndTime()
                                            : occ.getStartTime());
   ...
   * <p>
   * Cria um evento que ocorre toda segunda e quarta-feira, às 14:00, com
   * duração de 2 horas.
   */
  public void exemploEventoSemanalDiasEspecificos() {
    ...
    IntervaloTemporalDTO intervalo = IntervaloTemporalDTO.builder()
        ...
        .startTime(LocalTime.of(14, 0)).endDate(LocalDate.of(2026, 1, 13))
    ...
    RecorrenciaDTO regra = RecorrenciaDTO.builder()
        .frequency(Frequencia.SEMANALMENTE).intervalValue(1)
        .byDay(diasSemana).build();
    ...
    List<IntervaloTemporalDTO> occurrences = calculator
        .generateOccurrences(periodicidade, from, 6);
    ...
    for (IntervaloTemporalDTO occ : occurrences) {
      ...
      String endStr = (occ.getEndDate() != null ? occ.getEndDate()
          ...
          + " " + (occ.getEndTime() != null ? occ.getEndTime()
                                            : occ.getStartTime());
      System.out.println("  - " + occ.getStartDate() + " "
          + occ.getStartTime() + " até " + endStr + " ("
   ...
   * <p>
   * Cria um evento que ocorre no 1º e 15º dia de cada mês, às 09:00.
   */
  public void exemploEventoMensalDiasEspecificos() {
    System.out.println("\n=== Exemplo 3: Evento Mensal (1º e 15º) ===");

    IntervaloTemporalDTO intervalo = IntervaloTemporalDTO.builder()
        .startDate(LocalDate.of(2026, 1, 1)).startTime(LocalTime.of(9, 0))
        .endDate(LocalDate.of(2026, 1, 1)).endTime(LocalTime.of(10, 0))
        .build();
    ...
    RecorrenciaDTO regra = RecorrenciaDTO.builder()
        .frequency(Frequencia.MENSALMENTE).intervalValue(1)
        .byMonthDay(diasMes).build();
    ...
    for (IntervaloTemporalDTO occ : occurrences) {
      System.out
          .println("  - " + occ.getStartDate() + " " + occ.getStartTime());
    }
  ...
  public void exemploComDataTermino() {
    ...
    IntervaloTemporalDTO intervalo = IntervaloTemporalDTO.builder()
        ...
        .endDate(LocalDate.of(2026, 1, 1)).endTime(LocalTime.of(9, 0))
        .build();

    RecorrenciaDTO regra = RecorrenciaDTO.builder()
        .frequency(Frequencia.DIARIAMENTE).intervalValue(1)
    ...
    List<IntervaloTemporalDTO> occurrences = calculator
        .generateOccurrences(periodicidade, from, end);
  ...
  public void exemploComLimiteOccorrências() {
    ...
    IntervaloTemporalDTO intervalo = IntervaloTemporalDTO.builder()
        .startDate(LocalDate.of(2025, 1, 1)).startTime(LocalTime.of(19, 0))
        .endDate(LocalDate.of(2025, 1, 1)).endTime(LocalTime.of(22, 0))
        .build();

    RecorrenciaDTO regra = RecorrenciaDTO.builder()
        .frequency(Frequencia.SEMANALMENTE).intervalValue(1).countLimit(4) // Apenas
                                                                           // 4
                                                                           // ocorrências
        .build();
    ...
    ZonedDateTime from = ZonedDateTime.of(2025, 1, 1, 19, 0, 0, 0,
                                          ZoneId.of("America/Recife"));
    List<IntervaloTemporalDTO> occurrences = calculator
        .generateOccurrences(periodicidade, from, 10); // Request 10, mas limite
                                                       // é 4
   ...
   * <p>
   * Cria um evento que ocorre uma vez por ano, em um mês específico.
   */
  public void exemploEventoAnual() {
    System.out.println("\n=== Exemplo 6: Evento Anual ===");

    IntervaloTemporalDTO intervalo = IntervaloTemporalDTO.builder()
        .startDate(LocalDate.of(2025, 3, 20)).startTime(LocalTime.of(10, 0))
        .endDate(LocalDate.of(2025, 3, 20)).endTime(LocalTime.of(12, 0))
        .build();
    ...
    RecorrenciaDTO regra = RecorrenciaDTO.builder()
        .frequency(Frequencia.ANUALMENTE).intervalValue(1).byMonth(meses)
        .build();
    ...
    ZonedDateTime from = ZonedDateTime.of(2025, 1, 1, 0, 0, 0, 0,
                                          ZoneId.of("America/Recife"));
    List<IntervaloTemporalDTO> occurrences = calculator
        .generateOccurrences(periodicidade, from, 3);
  ...
  public void exemploComExcecoes() {
    ...
    IntervaloTemporalDTO intervalo = IntervaloTemporalDTO.builder()
        .startDate(LocalDate.of(2025, 1, 1)).startTime(LocalTime.of(12, 0))
        .endDate(LocalDate.of(2025, 1, 1)).endTime(LocalTime.of(13, 0))
        .build();
    ...
    ZonedDateTime from = ZonedDateTime.of(2025, 1, 1, 12, 0, 0, 0,
                                          ZoneId.of("America/Recife"));
    List<IntervaloTemporalDTO> occurrences = calculator
        .generateOccurrences(periodicidade, from, 15);

    System.out
        .println("Próximas 15 ocorrências (com exceções em 05 e 12/01):");
    for (IntervaloTemporalDTO occ : occurrences) {
      System.out
          .println("  - " + occ.getStartDate() + " " + occ.getStartTime());
    }
  ...
  public void exemploComDatasInclusao() {
    ...
    IntervaloTemporalDTO intervalo = IntervaloTemporalDTO.builder()
        .startDate(LocalDate.of(2025, 1, 1)).startTime(LocalTime.of(15, 0))
        .endDate(LocalDate.of(2025, 1, 1)).endTime(LocalTime.of(16, 0))
        .build();
    ...
    RecorrenciaDTO regra = RecorrenciaDTO.builder()
        .frequency(Frequencia.SEMANALMENTE).intervalValue(1)
        .byDay(Set.of(DayOfWeek.MONDAY)).build();

    PeriodicidadeDTO periodicidade = PeriodicidadeDTO.builder()
        .intervaloBase(intervalo).regra(regra).includeDates(includeDates)
        .zoneId(ZoneId.of("America/Recife").getId()).build();
    ...
    System.out
        .println("Próximas ocorrências (incluindo datas específicas):");
    for (IntervaloTemporalDTO occ : occurrences) {
      System.out
          .println("  - " + occ.getStartDate() + " " + occ.getStartTime());
    }
   ...
   * <p>
   * Verifica se dois eventos periódicos têm interseção em um determinado
   * período.
   */
  public void exemploVerificarInterseccao() {
    ...
    IntervaloTemporalDTO intervaloA = IntervaloTemporalDTO.builder()
        .startDate(LocalDate.of(2025, 1, 1)).startTime(LocalTime.of(10, 0))
        .endDate(LocalDate.of(2025, 1, 1)).endTime(LocalTime.of(11, 0))
        .build();
    ...
    PeriodicidadeDTO eventoA = PeriodicidadeDTO.builder()
        .intervaloBase(intervaloA).regra(regraA)
        .zoneId(ZoneId.of("America/Recife").getId()).build();
    ...
    IntervaloTemporalDTO intervaloB = IntervaloTemporalDTO.builder()
        ...
        .startTime(LocalTime.of(10, 30)).endDate(LocalDate.of(2025, 1, 7))
        .endTime(LocalTime.of(11, 30)).build();

    RecorrenciaDTO regraB = RecorrenciaDTO.builder()
        .frequency(Frequencia.SEMANALMENTE).byDay(Set.of(DayOfWeek.TUESDAY))
        .build();

    PeriodicidadeDTO eventoB = PeriodicidadeDTO.builder()
        .intervaloBase(intervaloB).regra(regraB)
        .zoneId(ZoneId.of("America/Recife").getId()).build();
    ...
    boolean intersecta = calculator.intersects(eventoA, eventoB, inicio,
                                               fim, zone);
  ...
  public void exemploIntervaloMaiorQueUm() {
    ...
    IntervaloTemporalDTO intervalo = IntervaloTemporalDTO.builder()
        ...
        .startTime(LocalTime.of(18, 0)).endDate(LocalDate.of(2025, 1, 6))
        .endTime(LocalTime.of(20, 0)).build();

    RecorrenciaDTO regra = RecorrenciaDTO.builder()
        .frequency(Frequencia.SEMANALMENTE).intervalValue(2) // A cada 2 semanas
        .build();
   ...
   * <p>
   * Cria um evento que ocorre toda terça-feira na segunda semana do mês, das
   * 18:30 às 20:30.
   * <p>
  ...
  public void exemploSegundaSemanaMes() {
    ...
    IntervaloTemporalDTO intervalo = IntervaloTemporalDTO.builder()
        ...
        .startTime(LocalTime.of(18, 30)).endDate(LocalDate.of(2026, 1, 1))
        .endTime(LocalTime.of(20, 30)).build();
    ...
    RecorrenciaDTO regra = RecorrenciaDTO.builder()
        .frequency(Frequencia.MENSALMENTE).intervalValue(1)
        .byDay(Set.of(DayOfWeek.TUESDAY)).bySetPosition(Set.of(2))  // Segunda
                                                                    // terça do
        // mês
        .build();
   ...
   * <p>
   * Cria um evento que ocorre toda terça-feira na segunda semana do mês, das
   * 18:30 às 20:30, gerando ocorrências entre 01/01/2026 e 31/12/2026.
   * <p>
  ...
  public void exemploSegundaSemanaMesComPeriodo() {
    ...
    IntervaloTemporalDTO intervalo = IntervaloTemporalDTO.builder()
        .startDate(LocalDate.of(2026, 1, 1)).startTime(LocalTime.of(18, 30))
        .endDate(LocalDate.of(2026, 1, 1)).endTime(LocalTime.of(20, 30))
        .build();
    ...
    List<IntervaloTemporalDTO> occurrences = calculator
        .generateOccurrences(periodicidade, start, end);

    System.out.println("Ocorrências de 01/01/2026 até 31/12/2026 ("
        + occurrences.size() + " ocorrências):");
    for (IntervaloTemporalDTO occ : occurrences) {
      String endStr = (occ.getEndDate() != null ? occ.getEndDate()
                                                : occ.getStartDate())
          + " " + (occ.getEndTime() != null ? occ.getEndTime()
