...
public final class QuartzJobTranslator {
  ...
  public static final class HELP {
    ...
    public static final String INSTANCE_ID = "quartz.job.instance.id.help";
    public static final String RESULT = "quartz.job.result.help";
    public static final String FIRE_TIME = "quartz.job.fire.time.help";
    public static final String SCHEDULED_FIRE_TIME = "quartz.job.scheduled.fire.time.help";
    public static final String COMPLETED_EXECUTION_TIME = "quartz.job.completed.execution.time.help";
    public static final String RECOVERED = "quartz.job.recovered.help";
    public static final String TRIGGER_NAME = "quartz.job.trigger.name.help";
    public static final String TRIGGER_GROUP = "quartz.job.trigger.group.help";
    public static final String JOB_EXECUTED = "quartz.job.job.executed.help";
    public static final String EXCEPTION_MESSAGE = "quartz.job.exception.message.help";
    public static final String JOB_DATA_MAP = "quartz.job.job.data.map.help";
  }
  ...
  /**
   * Trigger related field name constants.
   */
  ...
  /**
   * Action constants for job operations.
   */
