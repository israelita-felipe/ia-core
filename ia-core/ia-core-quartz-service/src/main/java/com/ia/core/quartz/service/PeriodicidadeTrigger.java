...
public class PeriodicidadeTrigger
    ...
    private static final int MISFIRE_INSTRUCTION_DO_NOTHING = 2;
    ...
    public Date computeFirstFireTime(org.quartz.Calendar calendar) {
        ...
        if (periodicidade.getIntervaloBase() == null
            || periodicidade.getIntervaloBase().getStartDate() == null
            || periodicidade.getIntervaloBase().getStartTime() == null) {
            log.error("PeriodicidadeTrigger - intervaloBase ou campos nulos: intervaloBase={}, startDate={}, startTime={}",
                periodicidade.getIntervaloBase(),
                periodicidade.getIntervaloBase() != null ? periodicidade.getIntervaloBase().getStartDate() : null,
                periodicidade.getIntervaloBase() != null ? periodicidade.getIntervaloBase().getStartTime() : null);
            return null;
        }
        ...
        if (next.isEmpty()) {
            log.error("PeriodicidadeTrigger - nextOccurrence retornou vazio para periodicidade: {}", periodicidade);
            return null;
        }
        ...
        log.debug("PeriodicidadeTrigger - computeFirstFireTime retornou: {}", nextDate);
        return nextDate;
