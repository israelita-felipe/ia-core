...
## Descrição
Caso de teste para a camada model da classe `com.ia.core.quartz.CoreSpringBeanJobFactory`.

## Classe Testada
`com.ia.core.quartz.CoreSpringBeanJobFactory`

## Stack do Quartz
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.quartz.CoreSpringBeanJobFactory](ia-core-quartz-service/src/main/java/com/ia/core/quartz/CoreSpringBeanJobFactory.java) | Implementado |
...
| ServiceModel | [com.ia.core.quartz.CoreSpringBeanJobFactory](ia-core-quartz-service/src/main/java/com/ia/core/quartz/CoreSpringBeanJobFactory.java) | Não implementado |
...
## Objetivo
Documentar e validar a camada model de `CoreSpringBeanJobFactory` dentro da stack de agendamento e recorrência do `ia-core-quartz-*`.
...
- Classe: [`CoreSpringBeanJobFactory`](ia-core-quartz-service/src/main/java/com/ia/core/quartz/CoreSpringBeanJobFactory.java)
