# Caso de Teste: SchedulerConfigTriggerSearchRequest - ServiceModel

## Descrição
Caso de teste para a camada servicemodel da classe `com.ia.core.quartz.service.model.scheduler.dto.triggers.SchedulerConfigTriggerSearchRequest`.

## Classe Testada
`com.ia.core.quartz.service.model.scheduler.dto.triggers.SchedulerConfigTriggerSearchRequest`

## Stack do Quartz
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.quartz.service.model.scheduler.dto.triggers.SchedulerConfigTriggerSearchRequest](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/scheduler/dto/triggers/SchedulerConfigTriggerSearchRequest.java) | Implementado |
...
| ServiceModel | [com.ia.core.quartz.service.model.scheduler.dto.triggers.SchedulerConfigTriggerSearchRequest](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/scheduler/dto/triggers/SchedulerConfigTriggerSearchRequest.java) | Implementado |
...
## Objetivo
Documentar e validar a camada servicemodel de `SchedulerConfigTriggerSearchRequest` dentro da stack de agendamento e recorrência do `ia-core-quartz-*`.

## Fluxo do Teste
1. Dado o contexto de agendamento `Agendamento` no domínio Quartz.
2. Quando a camada servicemodel recebe, produz ou transforma dados compatíveis com `SchedulerConfigTriggerSearchRequest`.
...
**Given**: Dados válidos para `SchedulerConfigTriggerSearchRequest` no contexto `Agendamento`.
**When**: A camada servicemodel processa o componente.
...
**When**: A camada servicemodel valida ou transforma `SchedulerConfigTriggerSearchRequest`.
...
**Given**: Caso de teste documentado para `SchedulerConfigTriggerSearchRequest`.
...
| Campo | Valor |
|-------|-------|
| Componente | `SchedulerConfigTriggerSearchRequest - ServiceModel` |
| Camada | ServiceModel |
...
- Classe: [`SchedulerConfigTriggerSearchRequest`](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/scheduler/dto/triggers/SchedulerConfigTriggerSearchRequest.java)
