# Caso de Teste: OccurrenceCalculator - ServiceModel

## Descrição
Caso de teste para a camada servicemodel da classe `com.ia.core.quartz.service.model.recorrencia.dto.OccurrenceCalculator`.

## Classe Testada
`com.ia.core.quartz.service.model.recorrencia.dto.OccurrenceCalculator`

## Stack do Quartz
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.quartz.service.model.recorrencia.dto.OccurrenceCalculator](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/recorrencia/dto/OccurrenceCalculator.java) | Implementado |
...
| ServiceModel | [com.ia.core.quartz.service.model.recorrencia.dto.OccurrenceCalculator](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/recorrencia/dto/OccurrenceCalculator.java) | Implementado |
...
## Objetivo
Documentar e validar a camada servicemodel de `OccurrenceCalculator` dentro da stack de agendamento e recorrência do `ia-core-quartz-*`.

## Fluxo do Teste
1. Dado o contexto de agendamento `Periodicidade/Recorrência` no domínio Quartz.
2. Quando a camada servicemodel recebe, produz ou transforma dados compatíveis com `OccurrenceCalculator`.
...
**Given**: Dados válidos para `OccurrenceCalculator` no contexto `Periodicidade/Recorrência`.
...
**When**: A camada servicemodel valida ou transforma `OccurrenceCalculator`.
...
**Given**: Caso de teste documentado para `OccurrenceCalculator`.
...
| Campo | Valor |
|-------|-------|
| Componente | `OccurrenceCalculator - ServiceModel` |
| Camada | ServiceModel |
...
- Classe: [`OccurrenceCalculator`](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/recorrencia/dto/OccurrenceCalculator.java)
