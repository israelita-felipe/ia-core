# Caso de Teste: IntervaloTemporal - Model

## Descrição
Caso de teste para a camada model da classe `com.ia.core.quartz.model.periodicidade.IntervaloTemporal`.
...
|--------|------------|--------|
| Model | [com.ia.core.quartz.model.periodicidade.IntervaloTemporal](ia-core-quartz-model/src/main/java/com/ia/core/quartz/model/periodicidade/IntervaloTemporal.java) | Implementado |
...
| ServiceModel | [com.ia.core.quartz.model.periodicidade.IntervaloTemporal](ia-core-quartz-model/src/main/java/com/ia/core/quartz/model/periodicidade/IntervaloTemporal.java) | Não implementado |
...
## Objetivo
Documentar e validar a camada model de `IntervaloTemporal` dentro da stack de agendamento e recorrência do `ia-core-quartz-*`.

## Fluxo do Teste
1. Dado o contexto de agendamento `Periodicidade/Recorrência` no domínio Quartz.
2. Quando a camada model recebe, produz ou transforma dados compatíveis com `IntervaloTemporal`.
...
**Given**: Dados válidos para `IntervaloTemporal` no contexto `Periodicidade/Recorrência`.
...
**When**: A camada model valida ou transforma `IntervaloTemporal`.
...
**Given**: Caso de teste documentado para `IntervaloTemporal`.
...
| Campo | Valor |
|-------|-------|
| Componente | `IntervaloTemporal - Model` |
| Camada | Model |
...
- Classe: [`IntervaloTemporal`](ia-core-quartz-model/src/main/java/com/ia/core/quartz/model/periodicidade/IntervaloTemporal.java)
