# Caso de Teste: IntervaloTemporalDTO - ServiceModel

## Descrição
Caso de teste para a camada servicemodel da classe `com.ia.core.quartz.service.model.periodicidade.dto.IntervaloTemporalDTO`.

## Classe Testada
`com.ia.core.quartz.service.model.periodicidade.dto.IntervaloTemporalDTO`

## Stack do Quartz
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.quartz.service.model.periodicidade.dto.IntervaloTemporalDTO](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/periodicidade/dto/IntervaloTemporalDTO.java) | Implementado |
...
| ServiceModel | [com.ia.core.quartz.service.model.periodicidade.dto.IntervaloTemporalDTO](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/periodicidade/dto/IntervaloTemporalDTO.java) | Implementado |
...
## Objetivo
Documentar e validar a camada servicemodel de `IntervaloTemporalDTO` dentro da stack de agendamento e recorrência do `ia-core-quartz-*`.

## Fluxo do Teste
1. Dado o contexto de agendamento `Periodicidade/Recorrência` no domínio Quartz.
2. Quando a camada servicemodel recebe, produz ou transforma dados compatíveis com `IntervaloTemporalDTO`.
...
**Given**: Dados válidos para `IntervaloTemporalDTO` no contexto `Periodicidade/Recorrência`.
...
**When**: A camada servicemodel valida ou transforma `IntervaloTemporalDTO`.
...
**Given**: Caso de teste documentado para `IntervaloTemporalDTO`.
...
| Campo | Valor |
|-------|-------|
| Componente | `IntervaloTemporalDTO - ServiceModel` |
| Camada | ServiceModel |
...
- Classe: [`IntervaloTemporalDTO`](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/periodicidade/dto/IntervaloTemporalDTO.java)
