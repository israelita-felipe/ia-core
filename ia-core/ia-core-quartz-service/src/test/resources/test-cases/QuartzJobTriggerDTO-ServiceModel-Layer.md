# Caso de Teste: QuartzJobTriggerDTO - ServiceModel

## Descrição
Caso de teste para a camada servicemodel da classe `com.ia.core.quartz.service.model.job.dto.QuartzJobTriggerDTO`.

## Classe Testada
`com.ia.core.quartz.service.model.job.dto.QuartzJobTriggerDTO`

## Stack do Quartz
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.quartz.service.model.job.dto.QuartzJobTriggerDTO](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/job/dto/QuartzJobTriggerDTO.java) | Implementado |
...
| ServiceModel | [com.ia.core.quartz.service.model.job.dto.QuartzJobTriggerDTO](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/job/dto/QuartzJobTriggerDTO.java) | Implementado |
...
## Objetivo
Documentar e validar a camada servicemodel de `QuartzJobTriggerDTO` dentro da stack de agendamento e recorrência do `ia-core-quartz-*`.

## Fluxo do Teste
1. Dado o contexto de agendamento `Jobs` no domínio Quartz.
2. Quando a camada servicemodel recebe, produz ou transforma dados compatíveis com `QuartzJobTriggerDTO`.
...
**Given**: Dados válidos para `QuartzJobTriggerDTO` no contexto `Jobs`.
...
**When**: A camada servicemodel valida ou transforma `QuartzJobTriggerDTO`.
...
**Given**: Caso de teste documentado para `QuartzJobTriggerDTO`.
...
| Campo | Valor |
|-------|-------|
| Componente | `QuartzJobTriggerDTO - ServiceModel` |
| Camada | ServiceModel |
...
- Classe: [`QuartzJobTriggerDTO`](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/job/dto/QuartzJobTriggerDTO.java)
