# Caso de Teste: ExclusaoRecorrenciaDTO - Repository

## Descrição
Caso de teste para a camada repository da classe `com.ia.core.quartz.service.model.recorrencia.dto.ExclusaoRecorrenciaDTO`.
...
| ServiceModel | [com.ia.core.quartz.service.model.recorrencia.dto.ExclusaoRecorrenciaDTO](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/recorrencia/dto/ExclusaoRecorrenciaDTO.java) | Não implementado |
...
## Objetivo
Documentar e validar a camada repository de `ExclusaoRecorrenciaDTO` dentro da stack de agendamento e recorrência do `ia-core-quartz-*`.

## Fluxo do Teste
1. Dado o contexto de agendamento `Periodicidade/Recorrência` no domínio Quartz.
2. Quando a camada repository recebe, produz ou transforma dados compatíveis com `ExclusaoRecorrenciaDTO`.
...
**When**: A camada repository valida ou transforma `ExclusaoRecorrenciaDTO`.
...
| Campo | Valor |
|-------|-------|
| Componente | `ExclusaoRecorrenciaDTO - Repository` |
| Camada | Repository |
