# Caso de Teste: ExclusaoRecorrenciaDTO - ServiceModel

## Descrição
Caso de teste para a camada servicemodel da classe `com.ia.core.quartz.service.model.recorrencia.dto.ExclusaoRecorrenciaDTO`.
...
|--------|------------|--------|
| Model | [com.ia.core.quartz.service.model.recorrencia.dto.ExclusaoRecorrenciaDTO](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/recorrencia/dto/ExclusaoRecorrenciaDTO.java) | Implementado |
...
| ServiceModel | [com.ia.core.quartz.service.model.recorrencia.dto.ExclusaoRecorrenciaDTO](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/recorrencia/dto/ExclusaoRecorrenciaDTO.java) | Implementado |
...
## Objetivo
Documentar e validar a camada servicemodel de `ExclusaoRecorrenciaDTO` dentro da stack de agendamento e recorrência do `ia-core-quartz-*`.

## Fluxo do Teste
1. Dado o contexto de agendamento `Periodicidade/Recorrência` no domínio Quartz.
2. Quando a camada servicemodel recebe, produz ou transforma dados compatíveis com `ExclusaoRecorrenciaDTO`.
...
**Given**: Dados válidos para `ExclusaoRecorrenciaDTO` no contexto `Periodicidade/Recorrência`.
...
**When**: A camada servicemodel valida ou transforma `ExclusaoRecorrenciaDTO`.
...
**Given**: Caso de teste documentado para `ExclusaoRecorrenciaDTO`.
...
| Campo | Valor |
|-------|-------|
| Componente | `ExclusaoRecorrenciaDTO - ServiceModel` |
| Camada | ServiceModel |
...
- Classe: [`ExclusaoRecorrenciaDTO`](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/recorrencia/dto/ExclusaoRecorrenciaDTO.java)
