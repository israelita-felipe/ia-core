# Caso de Teste: IntervaloTemporalFormViewModel - View

## Descrição
Caso de teste para a camada view da classe `com.ia.core.quartz.view.periodicidade.form.IntervaloTemporalFormViewModel`.

## Classe Testada
`com.ia.core.quartz.view.periodicidade.form.IntervaloTemporalFormViewModel`

## Stack do Quartz
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.quartz.view.periodicidade.form.IntervaloTemporalFormViewModel](ia-core-quartz-view/src/main/java/com/ia/core/quartz/view/periodicidade/form/IntervaloTemporalFormViewModel.java) | Implementado |
...
| ServiceModel | [com.ia.core.quartz.view.periodicidade.form.IntervaloTemporalFormViewModel](ia-core-quartz-view/src/main/java/com/ia/core/quartz/view/periodicidade/form/IntervaloTemporalFormViewModel.java) | Não implementado |
...
## Objetivo
Documentar e validar a camada view de `IntervaloTemporalFormViewModel` dentro da stack de agendamento e recorrência do `ia-core-quartz-*`.

## Fluxo do Teste
1. Dado o contexto de agendamento `Periodicidade/Recorrência` no domínio Quartz.
2. Quando a camada view recebe, produz ou transforma dados compatíveis com `IntervaloTemporalFormViewModel`.
...
**Given**: Dados válidos para `IntervaloTemporalFormViewModel` no contexto `Periodicidade/Recorrência`.
...
**When**: A camada view valida ou transforma `IntervaloTemporalFormViewModel`.
...
**Given**: Caso de teste documentado para `IntervaloTemporalFormViewModel`.
...
| Campo | Valor |
|-------|-------|
| Componente | `IntervaloTemporalFormViewModel - View` |
| Camada | View |
...
- Classe: [`IntervaloTemporalFormViewModel`](ia-core-quartz-view/src/main/java/com/ia/core/quartz/view/periodicidade/form/IntervaloTemporalFormViewModel.java)
