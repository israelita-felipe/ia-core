# Caso de Teste: Recorrencia - Model

## Descrição
Caso de teste para a camada model da classe `com.ia.core.quartz.model.periodicidade.Recorrencia`.
...
|--------|------------|--------|
| Model | [com.ia.core.quartz.model.periodicidade.Recorrencia](ia-core-quartz-model/src/main/java/com/ia/core/quartz/model/periodicidade/Recorrencia.java) | Implementado |
...
| ServiceModel | [com.ia.core.quartz.model.periodicidade.Recorrencia](ia-core-quartz-model/src/main/java/com/ia/core/quartz/model/periodicidade/Recorrencia.java) | Não implementado |
...
## Objetivo
Documentar e validar a camada model de `Recorrencia` dentro da stack de agendamento e recorrência do `ia-core-quartz-*`.

## Fluxo do Teste
1. Dado o contexto de agendamento `Periodicidade/Recorrência` no domínio Quartz.
2. Quando a camada model recebe, produz ou transforma dados compatíveis com `Recorrencia`.
...
**Given**: Dados válidos para `Recorrencia` no contexto `Periodicidade/Recorrência`.
...
**When**: A camada model valida ou transforma `Recorrencia`.
...
**Given**: Caso de teste documentado para `Recorrencia`.
...
- Classe: [`Recorrencia`](ia-core-quartz-model/src/main/java/com/ia/core/quartz/model/periodicidade/Recorrencia.java)
