# Caso de Teste: ExclusaoRecorrencia - Model

## Descrição
Caso de teste para a camada model da classe `com.ia.core.quartz.model.periodicidade.ExclusaoRecorrencia`.

## Classe Testada
`com.ia.core.quartz.model.periodicidade.ExclusaoRecorrencia`

## Stack do Quartz
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.quartz.model.periodicidade.ExclusaoRecorrencia](ia-core-quartz-model/src/main/java/com/ia/core/quartz/model/periodicidade/ExclusaoRecorrencia.java) | Implementado |
...
| ServiceModel | [com.ia.core.quartz.model.periodicidade.ExclusaoRecorrencia](ia-core-quartz-model/src/main/java/com/ia/core/quartz/model/periodicidade/ExclusaoRecorrencia.java) | Não implementado |
...
## Objetivo
Documentar e validar a camada model de `ExclusaoRecorrencia` dentro da stack de agendamento e recorrência do `ia-core-quartz-*`.

## Fluxo do Teste
1. Dado o contexto de agendamento `Periodicidade/Recorrência` no domínio Quartz.
2. Quando a camada model recebe, produz ou transforma dados compatíveis com `ExclusaoRecorrencia`.
...
**Given**: Dados válidos para `ExclusaoRecorrencia` no contexto `Periodicidade/Recorrência`.
...
**When**: A camada model valida ou transforma `ExclusaoRecorrencia`.
...
**Given**: Caso de teste documentado para `ExclusaoRecorrencia`.
...
| Campo | Valor |
|-------|-------|
| Componente | `ExclusaoRecorrencia - Model` |
| Camada | Model |
...
- Classe: [`ExclusaoRecorrencia`](ia-core-quartz-model/src/main/java/com/ia/core/quartz/model/periodicidade/ExclusaoRecorrencia.java)
