# Caso de Teste: QuartzJobDTO - ServiceModel

## Descrição
Caso de teste para a camada servicemodel da classe `com.ia.core.quartz.service.model.job.dto.QuartzJobDTO`.

## Classe Testada
`com.ia.core.quartz.service.model.job.dto.QuartzJobDTO`

## Stack do Quartz
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.quartz.service.model.job.dto.QuartzJobDTO](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/job/dto/QuartzJobDTO.java) | Implementado |
...
| ServiceModel | [com.ia.core.quartz.service.model.job.dto.QuartzJobDTO](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/job/dto/QuartzJobDTO.java) | Implementado |
...
## Objetivo
Documentar e validar a camada servicemodel de `QuartzJobDTO` dentro da stack de agendamento e recorrência do `ia-core-quartz-*`.

## Fluxo do Teste
1. Dado o contexto de agendamento `Jobs` no domínio Quartz.
2. Quando a camada servicemodel recebe, produz ou transforma dados compatíveis com `QuartzJobDTO`.
...
**Given**: Dados válidos para `QuartzJobDTO` no contexto `Jobs`.
...
**When**: A camada servicemodel valida ou transforma `QuartzJobDTO`.
...
**Given**: Caso de teste documentado para `QuartzJobDTO`.
...
| Campo | Valor |
|-------|-------|
| Componente | `QuartzJobDTO - ServiceModel` |
| Camada | ServiceModel |
...
- Classe: [`QuartzJobDTO`](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/job/dto/QuartzJobDTO.java)
