# Caso de Teste: QuartzJobTriggerSearchRequest - ServiceModel

## Descrição
Caso de teste para a camada servicemodel da classe `com.ia.core.quartz.service.model.job.dto.QuartzJobTriggerSearchRequest`.

## Classe Testada
`com.ia.core.quartz.service.model.job.dto.QuartzJobTriggerSearchRequest`

## Stack do Quartz
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.quartz.service.model.job.dto.QuartzJobTriggerSearchRequest](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/job/dto/QuartzJobTriggerSearchRequest.java) | Implementado |
...
| ServiceModel | [com.ia.core.quartz.service.model.job.dto.QuartzJobTriggerSearchRequest](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/job/dto/QuartzJobTriggerSearchRequest.java) | Implementado |
...
## Objetivo
Documentar e validar a camada servicemodel de `QuartzJobTriggerSearchRequest` dentro da stack de agendamento e recorrência do `ia-core-quartz-*`.

## Fluxo do Teste
1. Dado o contexto de agendamento `Jobs` no domínio Quartz.
2. Quando a camada servicemodel recebe, produz ou transforma dados compatíveis com `QuartzJobTriggerSearchRequest`.
...
**Given**: Dados válidos para `QuartzJobTriggerSearchRequest` no contexto `Jobs`.
...
**When**: A camada servicemodel valida ou transforma `QuartzJobTriggerSearchRequest`.
...
**Given**: Caso de teste documentado para `QuartzJobTriggerSearchRequest`.
...
| Campo | Valor |
|-------|-------|
| Componente | `QuartzJobTriggerSearchRequest - ServiceModel` |
| Camada | ServiceModel |
...
- Classe: [`QuartzJobTriggerSearchRequest`](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/job/dto/QuartzJobTriggerSearchRequest.java)
