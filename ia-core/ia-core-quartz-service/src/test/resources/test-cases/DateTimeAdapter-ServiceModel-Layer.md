# Caso de Teste: DateTimeAdapter - ServiceModel

## Descrição
Caso de teste para a camada servicemodel da classe `com.ia.core.quartz.service.model.recorrencia.dto.DateTimeAdapter`.

## Classe Testada
`com.ia.core.quartz.service.model.recorrencia.dto.DateTimeAdapter`

## Stack do Quartz
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.quartz.service.model.recorrencia.dto.DateTimeAdapter](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/recorrencia/dto/DateTimeAdapter.java) | Implementado |
...
| ServiceModel | [com.ia.core.quartz.service.model.recorrencia.dto.DateTimeAdapter](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/recorrencia/dto/DateTimeAdapter.java) | Implementado |
...
## Objetivo
Documentar e validar a camada servicemodel de `DateTimeAdapter` dentro da stack de agendamento e recorrência do `ia-core-quartz-*`.

## Fluxo do Teste
1. Dado o contexto de agendamento `Periodicidade/Recorrência` no domínio Quartz.
2. Quando a camada servicemodel recebe, produz ou transforma dados compatíveis com `DateTimeAdapter`.
...
**Given**: Dados válidos para `DateTimeAdapter` no contexto `Periodicidade/Recorrência`.
...
**When**: A camada servicemodel valida ou transforma `DateTimeAdapter`.
...
**Given**: Caso de teste documentado para `DateTimeAdapter`.
...
| Campo | Valor |
|-------|-------|
| Componente | `DateTimeAdapter - ServiceModel` |
| Camada | ServiceModel |
...
- Classe: [`DateTimeAdapter`](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/recorrencia/dto/DateTimeAdapter.java)
