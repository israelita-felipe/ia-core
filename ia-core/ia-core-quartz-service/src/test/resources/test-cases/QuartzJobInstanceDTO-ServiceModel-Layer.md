# Caso de Teste: QuartzJobInstanceDTO - ServiceModel

## Descrição
Caso de teste para a camada servicemodel da classe `com.ia.core.quartz.service.model.job.dto.QuartzJobInstanceDTO`.
...
|--------|------------|--------|
| Model | [com.ia.core.quartz.service.model.job.dto.QuartzJobInstanceDTO](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/job/dto/QuartzJobInstanceDTO.java) | Implementado |
...
| ServiceModel | [com.ia.core.quartz.service.model.job.dto.QuartzJobInstanceDTO](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/job/dto/QuartzJobInstanceDTO.java) | Implementado |
...
## Objetivo
Documentar e validar a camada servicemodel de `QuartzJobInstanceDTO` dentro da stack de agendamento e recorrência do `ia-core-quartz-*`.

## Fluxo do Teste
1. Dado o contexto de agendamento `Jobs` no domínio Quartz.
2. Quando a camada servicemodel recebe, produz ou transforma dados compatíveis com `QuartzJobInstanceDTO`.
...
**Given**: Dados válidos para `QuartzJobInstanceDTO` no contexto `Jobs`.
...
**When**: A camada servicemodel valida ou transforma `QuartzJobInstanceDTO`.
...
**Given**: Caso de teste documentado para `QuartzJobInstanceDTO`.
...
| Campo | Valor |
|-------|-------|
| Componente | `QuartzJobInstanceDTO - ServiceModel` |
| Camada | ServiceModel |
...
- Classe: [`QuartzJobInstanceDTO`](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/job/dto/QuartzJobInstanceDTO.java)
