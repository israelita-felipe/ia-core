# Caso de Teste: IntervaloTemporalFormViewModelConfig - View

## Descrição
Caso de teste para a camada view da classe `com.ia.core.quartz.view.periodicidade.form.IntervaloTemporalFormViewModelConfig`.

## Classe Testada
`com.ia.core.quartz.view.periodicidade.form.IntervaloTemporalFormViewModelConfig`

## Stack do Quartz
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.quartz.view.periodicidade.form.IntervaloTemporalFormViewModelConfig](ia-core-quartz-view/src/main/java/com/ia/core/quartz/view/periodicidade/form/IntervaloTemporalFormViewModelConfig.java) | Implementado |
...
| ServiceModel | [com.ia.core.quartz.view.periodicidade.form.IntervaloTemporalFormViewModelConfig](ia-core-quartz-view/src/main/java/com/ia/core/quartz/view/periodicidade/form/IntervaloTemporalFormViewModelConfig.java) | Não implementado |
...
## Objetivo
Documentar e validar a camada view de `IntervaloTemporalFormViewModelConfig` dentro da stack de agendamento e recorrência do `ia-core-quartz-*`.

## Fluxo do Teste
1. Dado o contexto de agendamento `Periodicidade/Recorrência` no domínio Quartz.
2. Quando a camada view recebe, produz ou transforma dados compatíveis com `IntervaloTemporalFormViewModelConfig`.
...
**Given**: Dados válidos para `IntervaloTemporalFormViewModelConfig` no contexto `Periodicidade/Recorrência`.
...
**When**: A camada view valida ou transforma `IntervaloTemporalFormViewModelConfig`.
...
**Given**: Caso de teste documentado para `IntervaloTemporalFormViewModelConfig`.
...
| Campo | Valor |
|-------|-------|
| Componente | `IntervaloTemporalFormViewModelConfig - View` |
| Camada | View |
...
- Classe: [`IntervaloTemporalFormViewModelConfig`](ia-core-quartz-view/src/main/java/com/ia/core/quartz/view/periodicidade/form/IntervaloTemporalFormViewModelConfig.java)
