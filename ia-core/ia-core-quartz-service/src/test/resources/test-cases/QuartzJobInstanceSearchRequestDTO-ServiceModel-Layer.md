# Caso de Teste: QuartzJobInstanceSearchRequest - ServiceModel

## Descrição
Caso de teste para a camada servicemodel da classe `com.ia.core.quartz.service.model.job.dto.QuartzJobInstanceSearchRequest`.

## Classe Testada
`com.ia.core.quartz.service.model.job.dto.QuartzJobInstanceSearchRequest`

## Stack do Quartz
| Camada | Componente | Status |
|--------|------------|--------|
| Model | [com.ia.core.quartz.service.model.job.dto.QuartzJobInstanceSearchRequest](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/job/dto/QuartzJobInstanceSearchRequest.java) | Implementado |
...
| ServiceModel | [com.ia.core.quartz.service.model.job.dto.QuartzJobInstanceSearchRequest](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/job/dto/QuartzJobInstanceSearchRequest.java) | Implementado |
...
## Objetivo
Documentar e validar a camada servicemodel de `QuartzJobInstanceSearchRequest` dentro da stack de agendamento e recorrência do `ia-core-quartz-*`.

## Fluxo do Teste
1. Dado o contexto de agendamento `Jobs` no domínio Quartz.
2. Quando a camada servicemodel recebe, produz ou transforma dados compatíveis com `QuartzJobInstanceSearchRequest`.
...
**Given**: Dados válidos para `QuartzJobInstanceSearchRequest` no contexto `Jobs`.
...
**When**: A camada servicemodel valida ou transforma `QuartzJobInstanceSearchRequest`.
...
**Given**: Caso de teste documentado para `QuartzJobInstanceSearchRequest`.
...
| Campo | Valor |
|-------|-------|
| Componente | `QuartzJobInstanceSearchRequest - ServiceModel` |
| Camada | ServiceModel |
...
- Classe: [`QuartzJobInstanceSearchRequest`](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/job/dto/QuartzJobInstanceSearchRequest.java)
