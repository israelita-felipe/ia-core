# Caso de Teste: IntervaloTemporalDTO - Repository

## Descrição
Caso de teste para a camada repository da classe `com.ia.core.quartz.service.model.periodicidade.dto.IntervaloTemporalDTO`.
...
| ServiceModel | [com.ia.core.quartz.service.model.periodicidade.dto.IntervaloTemporalDTO](ia-core-quartz-service-model/src/main/java/com/ia/core/quartz/service/model/periodicidade/dto/IntervaloTemporalDTO.java) | Não implementado |
...
## Objetivo
Documentar e validar a camada repository de `IntervaloTemporalDTO` dentro da stack de agendamento e recorrência do `ia-core-quartz-*`.

## Fluxo do Teste
1. Dado o contexto de agendamento `Periodicidade/Recorrência` no domínio Quartz.
2. Quando a camada repository recebe, produz ou transforma dados compatíveis com `IntervaloTemporalDTO`.
...
**When**: A camada repository valida ou transforma `IntervaloTemporalDTO`.
...
| Campo | Valor |
|-------|-------|
| Componente | `IntervaloTemporalDTO - Repository` |
| Camada | Repository |
