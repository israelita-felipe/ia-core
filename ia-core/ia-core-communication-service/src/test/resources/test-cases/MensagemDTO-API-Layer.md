# MensagemDTO - Casos de Teste da Camada de API

## Visão Geral
Casos de teste para a classe `MensagemDTO`, verificando campos de transferência de dados de mensagens.
...
- **Dado**: Uma MensagemDTO com campos preenchidos
...
## Fluxo do Teste
1. Criar instância de MensagemDTO
