...
/**
 * Test class for MensagemValidator.
 * <p>
 * Tests the validation of MensagemDTO objects with business rules.
 * </p>
 *
 * @author Israel Araújo
 * @since 1.0.0
 */
@DisplayName("MensagemValidator Tests")
class MensagemValidatorTest extends CoreBaseUnitTest {

    @Mock
    private Translator translator;

    @Mock
    private BusinessRule<MensagemDTO> businessRule1;

    @Mock
    private BusinessRule<MensagemDTO> businessRule2;

    private MensagemValidator validator;
    private List<BusinessRule<MensagemDTO>> businessRules;
    ...
    void setUp() {
        ...
        validator = new MensagemValidator(translator, businessRules);
    }
    ...
    void shouldInitializeWithEmptyBusinessRules() {
        // Arrange
        List<BusinessRule<MensagemDTO>> emptyRules = new ArrayList<>();

        // Act
        MensagemValidator validatorWithEmptyRules = new MensagemValidator(translator, emptyRules);
