...
/**
 * Test class for ContatoMensagemValidator.
 * <p>
 * Tests the validation of ContatoMensagemDTO objects with business rules.
 * </p>
 *
 * @author Israel Araújo
 * @since 1.0.0
 */
@DisplayName("ContatoMensagemValidator Tests")
class ContatoMensagemValidatorTest extends CoreBaseUnitTest {

    @Mock
    private Translator translator;

    @Mock
    private BusinessRule<ContatoMensagemDTO> businessRule1;

    @Mock
    private BusinessRule<ContatoMensagemDTO> businessRule2;

    private ContatoMensagemValidator validator;
    private List<BusinessRule<ContatoMensagemDTO>> businessRules;
    ...
    void setUp() {
        ...
        validator = new ContatoMensagemValidator(translator, businessRules);
    }
    ...
    void shouldInitializeWithEmptyBusinessRules() {
        // Arrange
        List<BusinessRule<ContatoMensagemDTO>> emptyRules = new ArrayList<>();

        // Act
        ContatoMensagemValidator validatorWithEmptyRules = new ContatoMensagemValidator(translator, emptyRules);
