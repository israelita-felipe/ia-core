 ...
 * do serviço de mensagens, incluindo repositórios, factory de estratégias,
 * processador de variáveis e serviços de segurança.
 *
...
public class MensagemServiceConfig
  extends CrudSecuredBaseServiceConfig<Mensagem, MensagemDTO> {
