 ...
 * @since 1.0.0
 */
class MensagemSearchRequestDTO extends SearchRequestDTO {

    private static final Map<FilterProperty, Collection<FilterRequestDTO>> filterMap = new HashMap<>();

    /**
     * Construtor padrão que inicializa os filtros disponíveis.
     */
    protected MensagemSearchRequestDTO() {
     ...
     * {@inheritDoc}
     *
     * @return mapa contendo os filtros disponíveis para este DTO
     */
    @Override
