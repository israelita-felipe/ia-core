 ...
 */
public class UserPrivilegeFormViewModel
  extends FormViewModel<UserPrivilegeDTO> {
   ...
   */
  public UserPrivilegeFormViewModel(UserPrivilegeFormViewModelConfig config) {
    super(config);
   ...
   * @return
   */
  private PrivilegeOperationPageViewModel createPrivilegeOperationPageViewModel(UserPrivilegeFormViewModelConfig config) {
  ...
  public PrivilegeDTO getPrivilege() {
    UserPrivilegeDTO model = getModel();
    if (model == null) {
      return null;
    }
   ...
   * @return
   */
  private DefaultCollectionBaseManager<PrivilegeOperationDTO> createPrivilegeOperationManager(UserPrivilegeFormViewModelConfig config) {
  ...
  @Override
  public UserPrivilegeFormViewModelConfig getConfig() {
    return (UserPrivilegeFormViewModelConfig) super.getConfig();
  }
}
