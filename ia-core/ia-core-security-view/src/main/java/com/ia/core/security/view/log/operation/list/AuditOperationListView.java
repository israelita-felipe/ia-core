...
/**
 * View para exibição e manipulação de audit operation list.
 * <p>
 * Responsável por gerenciar as funcionalidades relacionadas a AuditOperationListView
 * dentro do sistema.
 *
 * @author IA
 * @since 1.0
 */
public class AuditOperationListView
   ...
   * @param viewModel
   */
  public AuditOperationListView(IListViewModel<LogOperationDTO> viewModel) {
    super(viewModel);
    createDetails();
    createDataProvider();
    setSizeFull();
  ...
  protected void createColumns() {
    ...
    addColumn(log -> $(log.getType()))
        .setHeader($(LogOperationTranslator.TYPE));
  ...
  private void createDataProvider() {
    ...
    withConfigurableFilter
        .setFilter(getViewModel().getAuditSearchRequest());
  ...
  @Override
  public AuditOperationListViewModel getViewModel() {
