...
/**
 * Classe base abstrata para testes de DTO.
 * Fornece métodos de teste comuns para verificar implementação correta da interface DTO.
 *
 * <p>Esta é uma classe base abstrata e não deve ser executada como teste.
 * Classes de teste concretas devem estender esta classe e implementar os métodos abstratos.
 *
 * <p>Para usar:
 * <pre>
 * {@code
 * @DisplayName("Testes de MeuDTO")
 * class MeuDTOTestCore extends CoreDTOUnitTest<MeuDTO> {
 *
 *     @Override
 ...
 * @param <T> Tipo do DTO a ser testado
 */
@Disabled("Classe de teste base, não deve ser executada diretamente")
public abstract class CoreDTOUnitTest<T> extends CoreBaseUnitTest {

    /**
     * Creates a DTO instance using Instancio.
     *
     * @return a new DTO instance with random data
     */
    protected T createDTO() {
        return createFixture(getDtoClass());
    }

    /**
     * Gets the DTO class from generic type parameter.
     *
     * @return the class of the DTO being tested
     */
    ...
    /**
     * Abstract method that returns the expected DTO interface class.
     * Subclasses override this to specify which interface the DTO should implement.
     *
     * @return the expected DTO interface class
     */
    protected abstract Class<?> getDtoInterface();

    /**
     * Verifies that the class implements the DTO interface.
     */
    @Test
    ...
    /**
     * Verifies that the DTO class has a static inner class CAMPOS
     * containing all field names as public static constants.
     */
    @Test
    ...
    /**
     * Gets all field names from a class including inherited fields.
     */
    ...
    /**
     * Gets all static final field values from CAMPOS inner class including inherited.
     */
