# Casos de Teste - ExclusaoRecorrencia

## Descrição
Testes para a classe ExclusaoRecorrencia que representa a regra de exclusão de recorrência de uma Periodicidade.
...
7. Verificar se bySetPosition é null
