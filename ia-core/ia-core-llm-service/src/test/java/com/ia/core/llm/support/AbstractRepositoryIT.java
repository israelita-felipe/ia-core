...
/**
 * Base class for integration tests of Repository layer. Uses HSQLDB in-memory
 * database for fast testing. Features: - Automatic transaction rollback after
 * each test - EntityManager injection for manual operations - Test profile
 * activation Usage:
 *
 * <pre>
 * {@code @DataJpaTest}
