# Caso de Teste: ChatSessionDTO - Mapper

## Descrição
Caso de teste para a camada mapper do DTO `ChatSessionDTO`. Sessão de chat com agente LLM, status, usuário e histórico conversacional.

## Classe Testada
[`com.ia.core.llm.service.chat.ChatSessionMapper`](../../../../ia-core-llm-service/src/main/java/com/ia/core/llm/service/chat/ChatSessionMapper.java)
...
| Mapper | [`com.ia.core.llm.service.chat.ChatSessionMapper`](../../../../ia-core-llm-service/src/main/java/com/ia/core/llm/service/chat/ChatSessionMapper.java) | Implementado |
...
## Objetivo
Documentar e validar a camada mapper de `ChatSessionDTO` dentro da stack completa do `ia-core-llm-*`.

## Fluxo do Teste
1. Dado o contexto do DTO `ChatSessionDTO` no domínio Conversação Chat.
2. Quando a camada mapper recebe ou produz dados compatíveis com `ChatSessionDTO`.
...
**When**: A camada mapper valida ou transforma `ChatSessionDTO`.
...
| Campo | Valor |
|-------|-------|
| Componente | `ChatSessionDTO - Mapper` |
| Camada | Mapper |
