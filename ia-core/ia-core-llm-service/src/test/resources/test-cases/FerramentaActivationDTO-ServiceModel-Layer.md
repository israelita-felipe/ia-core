# Caso de Teste: FerramentaActivationDTO - Service Model

## Descrição
Caso de teste para a camada service model do DTO `FerramentaActivationDTO`. Ativação de ferramenta ou subferramenta para execução por agente LLM.

## Classe Testada
`com.ia.core.llm.service.model...FerramentaActivationDTO`
...
| ServiceModel | [`com.ia.core.llm.service.model...FerramentaActivationDTO`](../../../../ia-core-llm-service-model/src/main/java/com/ia/core/llm/service/model/ferramenta/FerramentaActivationDTO.java) | Implementado |
...
## Objetivo
Documentar e validar a camada service model de `FerramentaActivationDTO` dentro da stack completa do `ia-core-llm-*`.

## Fluxo do Teste
1. Dado o contexto do DTO `FerramentaActivationDTO` no domínio Ferramenta LLM.
2. Quando a camada service model recebe ou produz dados compatíveis com `FerramentaActivationDTO`.
3. Então o comportamento deve preservar os campos `id`, `titulo`, `descricao`, `instrucoes`, `template`, `subFerramentas`.
...
**Given**: Dados válidos para `FerramentaActivationDTO` no contexto `Ferramenta LLM`.
...
**When**: A camada service model valida ou transforma `FerramentaActivationDTO`.
...
**Given**: Caso de teste documentado para `FerramentaActivationDTO`.
...
| Campo | Valor |
|-------|-------|
| Componente | `FerramentaActivationDTO - Service Model` |
...
- DTO: [`FerramentaActivationDTO`](../../../../ia-core-llm-service-model/src/main/java/com/ia/core/llm/service/model/ferramenta/FerramentaActivationDTO.java)
