...
## Descrição
Caso de teste para a camada service model do DTO `FerramentaMetadataDTO`. Metadados resumidos de ferramentas disponíveis para seleção pelo agente/view.
...
2. Quando a camada service model recebe ou produz dados compatíveis com `FerramentaMetadataDTO`.
