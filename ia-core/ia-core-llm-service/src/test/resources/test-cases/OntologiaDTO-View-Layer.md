# Caso de Teste: OntologiaDTO - View/Client

## Descrição
Caso de teste para a camada view/client do DTO `OntologiaDTO`. Representação, validação, exportação e manutenção de ontologias OWL.

## Classe Testada
`com.ia.core.llm.view.ontologia.OntologiaManager / OntologiaClient`

## Stack do DTO
| Camada | Componente | Status |
|--------|------------|--------|
| Model | `com.ia.core.llm.model.ontologia.Ontologia` | Implementado |
| Repository | `Não implementado` | Não implementado |
| Mapper | `com.ia.core.llm.service.agente.mapper.OntologiaMapper` | Implementado |
| ServiceModel | [`com.ia.core.llm.service.model...OntologiaDTO`](../../../../ia-core-llm-service-model/src/main/java/com/ia/core/llm/service/model/ontologia/OntologiaDTO.java) | Implementado |
...
## Objetivo
Documentar e validar a camada view/client de `OntologiaDTO` dentro da stack completa do `ia-core-llm-*`.

## Fluxo do Teste
1. Dado o contexto do DTO `OntologiaDTO` no domínio Ontologia OWL.
2. Quando a camada view/client recebe ou produz dados compatíveis com `OntologiaDTO`.
3. Então o comportamento deve preservar os campos `iri`, `nome`, `descricao`, `versao`, `prefixo`, `namespace`, `formato`, `conteudo`, `consistente`, `ultimaModificacao`, `dataCriacao`, `estatisticas`.
...
**Given**: Dados válidos para `OntologiaDTO` no contexto `Ontologia OWL`.
...
**When**: A camada view/client valida ou transforma `OntologiaDTO`.
...
**Given**: Caso de teste documentado para `OntologiaDTO`.
...
| Campo | Valor |
|-------|-------|
| Componente | `OntologiaDTO - View/Client` |
| Camada | View/Client |
...
- DTO: [`OntologiaDTO`](../../../../ia-core-llm-service-model/src/main/java/com/ia/core/llm/service/model/ontologia/OntologiaDTO.java)
