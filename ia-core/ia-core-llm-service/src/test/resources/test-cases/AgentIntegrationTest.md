# Caso de Teste: AgentIntegrationTest

## Descrição
Testa a integração entre serviços de agentes LLM, validando fluxos completos de construção de ontologia, contexto, e conversação.

## Classe Testada
`com.ia.core.llm.service.agente.AgentIntegrationTest`

## Fluxo do Teste
1. Dado serviços de agente configurados com mocks
...
## Cenários
- Fluxo de construção de ontologia -> contexto -> conversação
- Fluxo de refinamento de ontologia
- Fluxo de sessão conversacional completa
- Tratamento de erro quando sessão não existe
...
- Usar @Mock para ChatService, TemplateService
- Focar em testes de integração que não dependem de serviços complexos
...
| Campo | Valor |
|-------|-------|
| Componente | `AgentIntegrationTest` |
| Camada | Integração |
