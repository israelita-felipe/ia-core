...
## Descrição
Caso de teste para a camada modelo/dto do DTO `ChatSessionDTO`. Sessão de chat com agente LLM, status, usuário e histórico conversacional.
...
2. Quando a camada modelo/dto recebe ou produz dados compatíveis com `ChatSessionDTO`.
