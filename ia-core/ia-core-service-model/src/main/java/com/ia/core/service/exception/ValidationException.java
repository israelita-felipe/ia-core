 ...
 * <p>
 * This exception encapsulates a {@link ValidationResult} that contains all
 * validation errors in an organized structure (ordered by severity and grouped
 * by field).
 * </p>
 * <h2>Usage</h2>
 *
...
public class ValidationException
  ...
  /**
   * Constructs a new ValidationException with error code, message and
   * validation result.
   *
  ...
  public Stream<String> getErrors() {
    return validationResult.getErrors().parallelStream()
