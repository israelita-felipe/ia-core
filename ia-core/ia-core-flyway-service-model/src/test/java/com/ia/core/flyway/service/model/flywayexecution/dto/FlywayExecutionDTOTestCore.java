...
class FlywayExecutionDTOTestCore extends CoreDTOUnitTest<FlywayExecutionDTO<FlywayExecution>> {
    ...
    void deveCriarDTOComBuilder() {
        FlywayExecutionDTO<FlywayExecution> dto = FlywayExecutionDTO.<FlywayExecution>builder()
            .id(1L)
            .version(1L)
    ...
    void deveClonarDTOUsandoCloneObject() {
        ...
        FlywayExecutionDTO<FlywayExecution> clone = dto.cloneObject();
    ...
    void deveClonarDTOUsandoToBuilder() {
        ...
        FlywayExecutionDTO<FlywayExecution> modified = dto.toBuilder()
